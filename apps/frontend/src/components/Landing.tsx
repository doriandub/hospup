...
const landingData = {
  "brand": "Hospup",
  "navbar": ["Features", "Templates", "Pricing", "Resources"],
  "hero": {
    "title": "Create viral hotel clips in seconds",
    "subtitle": "L'outil qui met fin au manque d'inspiration et aux heures de montage, qui permet aux hôteliers novices en réseaux sociaux de performer sur les réseaux sociaux.",
...
// Logo Component
const Logo = () => (
  <div className="w-10 h-10 bg-gradient-to-tl from-[#115446] to-[#138a73] rounded-lg flex items-center justify-center mr-5 transition-all duration-300">
    <img 
      src="/logo.png" 
      alt="Hospup Logo" 
      width={24} 
      ...
      <div className="container max-w-[1200px] mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center">
            <Logo />
            <span className="font-bold bg-gradient-to-tl from-[#115446] to-[#138a73] bg-clip-text text-transparent" style={{ fontFamily: 'Inter', fontSize: '24pt' }}>{landingData.brand}</span>
          </div>
          ...
          <div className="flex items-center gap-4">
            <a href="/auth/login" className="border-2 border-gray-200 text-gray-700 px-6 py-2 rounded-2xl font-medium hover:border-[#115446] hover:text-[#115446] transition-colors">
              Login
            </a>
            <button className="bg-gradient-to-br from-[#138a73] to-[#115446] text-white px-6 py-2 rounded-2xl font-medium hover:scale-[1.01] transition-transform flex items-center gap-2">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                <path d="M8 1l2.5 5.5L16 8l-5.5 2.5L8 16l-2.5-5.5L0 8l5.5-2.5L8 1z" />
              </svg>
              Try {landingData.brand} Now
            </button>
          </div>
        </div>
      </div>
...
const Hero = () => {
  return (
    <section className="relative py-20 bg-[var(--bg)] overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 opacity-5">
        <svg width="100%" height="100%" className="absolute top-0 left-0">
          <defs>
            <pattern id="dots" patternUnits="userSpaceOnUse" width="20" height="20">
              <circle cx="10" cy="10" r="1" fill="var(--brand)" />
            </pattern>
          </defs>
      ...
      <div className="container max-w-[1200px] mx-auto px-4 md:px-6 text-center">
        ...
        <div className="inline-flex items-center bg-white rounded-full px-4 py-2 mb-8 shadow-sm">
          ...
          <span className="text-[var(--muted)] text-sm">{landingData.hero.starsLabel}</span>
        </div>
        ...
        {/* CTA Button */}
        <button 
          className="bg-gradient-to-br from-[#138a73] to-[#115446] text-white px-8 py-4 rounded-2xl text-lg font-medium hover:scale-[1.01] transition-transform shadow-lg"
          aria-label="Start creating viral hotel content today"
        >
    ...
    <section className="py-20 bg-white" aria-labelledby="videos-title">
      <div className="container max-w-[1200px] mx-auto px-4 md:px-6">
        ...
        <div className="text-center mb-12">
          <h2 id="videos-title" className="text-3xl md:text-4xl font-bold text-[var(--ink)] mb-4">
            <span className="text-[var(--brand)]">1+ Billion Views Generated</span>
          </h2>
          <p className="text-lg text-[var(--muted)]">We&apos;ve analyzed thousands of viral videos totaling billions of views. Based on what you want to showcase, we match the most relevant formats so you can recreate what already works.</p>
        </div>
...
const Steps = () => {
      ...
      case 0:
        return (
          <div className="bg-white rounded-2xl p-8 shadow-sm">
            <h3 className="text-2xl font-bold text-[var(--ink)] mb-2">{step.title}</h3>
            <p className="text-[var(--muted)] mb-6">{step.body}</p>
            
            {/* Property Selection + Description Interface like /generate */}
            <div className="space-y-6">
              <div>
                <h4 className="text-lg font-semibold text-[var(--ink)] mb-3">Sélectionnez votre propriété</h4>
                <div className="relative">
                  <select className="w-full p-4 pr-12 border border-gray-200 rounded-lg bg-white text-gray-900 appearance-none focus:ring-2 focus:ring-[var(--brand)] focus:border-transparent">
              ...
              <div>
                <div className="flex items-center gap-3 mb-3">
                  <h4 className="text-lg font-semibold text-[var(--ink)]">Décrivez votre vidéo</h4>
                ...
                <textarea
                  ...
                  className="w-full p-4 border border-gray-200 rounded-lg resize-none focus:ring-2 focus:ring-[var(--brand)] focus:border-transparent"
                  rows={4}
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6">
                ...
                <div className="space-y-4 text-sm">
                  <div className="flex justify-between items-center">
                    <div className="flex items-center space-x-2">
                      <svg className="w-4 h-4 text-[#115446]" viewBox="0 0 24 24" fill="currentColor">
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 rounded-lg p-4 text-center">
                  <svg className="w-5 h-5 text-[#115446] mx-auto mb-2" viewBox="0 0 24 24" fill="currentColor">
                    <polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/>
                    <polyline points="17 6 23 6 23 12"/>
                  </svg>
                  <div className="text-lg font-bold text-[#115446]">1.8%</div>
                ...
                <button className="w-full bg-[var(--brand)] text-white py-2 px-4 rounded-lg text-sm font-medium">
        ...
        return (
          <div className="bg-white rounded-2xl p-8 shadow-sm">
            ...
            <div className="space-y-6">
              {/* Timeline Preview */}
              <div className="bg-gray-50 rounded-lg p-4">
                <h4 className="text-sm font-semibold text-[var(--ink)] mb-3">Timeline de votre vidéo</h4>
                <div className="space-y-2">
                  <div className="flex items-center gap-3 p-2 bg-white rounded border">
                    ...
                    <button className="text-xs text-[var(--brand)]">Modifier</button>
                  </div>
                  <div className="flex items-center gap-3 p-2 bg-white rounded border">
              ...
              {/* Content Library */}
              <div>
                <h4 className="text-sm font-semibold text-[var(--ink)] mb-3">Votre bibliothèque de contenu</h4>
                <div className="grid grid-cols-4 gap-3">
                  {[1,2,3,4].map(i => (
                    <div key={i} className="aspect-video bg-gray-200 rounded cursor-pointer hover:ring-2 hover:ring-[var(--brand)]">
              ...
              {/* Text Overlay */}
              <div>
                <h4 className="text-sm font-semibold text-[var(--ink)] mb-3">Texte et sous-titres</h4>
                <textarea 
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <h4 className="font-semibold text-[var(--ink)] mb-3">Contenu généré :</h4>
                  <div className="space-y-2 text-sm">
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <h4 className="font-semibold text-[var(--ink)] mb-2">Caption générée :</h4>
                  ...
                  <p className="text-xs text-[var(--brand)]">#luxury #hotel #piscine #vue #relaxation</p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <button className="w-full border-2 border-[var(--brand)] text-[var(--brand)] py-3 px-4 rounded-xl font-medium">
  ...
  return (
    <section className="py-20 bg-[var(--bg)]" aria-labelledby="steps-title">
      <div className="container max-w-[1200px] mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
...
const Testimonials = () => {
  return (
    <section className="py-20 bg-white" aria-labelledby="testimonials-title">
      <div className="container max-w-[1200px] mx-auto px-4 md:px-6">
        <h2 id="testimonials-title" className="text-3xl md:text-4xl font-bold text-center text-[var(--ink)] mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {landingData.testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="bg-[var(--bg)] rounded-2xl p-6 hover:shadow-lg transition-shadow"
            >
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-gradient-to-br from-[var(--brand)] to-[var(--accent)] rounded-full flex items-center justify-center text-white font-bold mr-4">
                  {testimonial.name.split(' ').map(n => n[0]).join('')}
                </div>
                <div>
                  <div className="font-semibold text-[var(--ink)]">{testimonial.name}</div>
                  <div className="text-sm text-[var(--accent)] font-medium">{testimonial.badge} followers</div>
                </div>
              </div>
              <p className="text-[var(--muted)]">{testimonial.text}</p>
            </div>
          ))}
        </div>
      </div>
...
const FAQ = () => {
  ...
  return (
    <section className="py-20 bg-[var(--bg)]" aria-labelledby="faq-title">
      <div className="container max-w-[1200px] mx-auto px-4 md:px-6">
        <h2 id="faq-title" className="text-3xl md:text-4xl font-bold text-center text-[var(--ink)] mb-12">
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          {landingData.faq.map((question, index) => (
            <div key={index} className="bg-white rounded-2xl overflow-hidden shadow-sm">
              ...
              >
                <span className="font-semibold text-[var(--ink)]">{question}</span>
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
  ...
  return (
    <section className="py-16 bg-white border-b border-gray-100">
      <div className="container max-w-[1200px] mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-[var(--ink)] mb-4">
            Créer du contenu viral en quelques clics
          </h2>
        </div>
        ...
        <div className="max-w-7xl mx-auto mb-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-start">
            ...
            <div className="text-center relative">
              <h3 className="text-xl font-bold text-[var(--ink)] mb-6">Sélectionnez votre propriété</h3>
            ...
            <div className="text-center relative">
              <h3 className="text-2xl font-bold text-[var(--ink)] mb-6">Validez la meilleure idée</h3>
            ...
            <div className="text-center">
              <h3 className="text-2xl font-bold text-[var(--ink)] mb-6">Votre vidéo est prête en une minute</h3>
        ...
        <div className="text-center">
          <button className="bg-[var(--accent)] text-white px-8 py-3 rounded-2xl font-medium hover:scale-[1.01] transition-transform">
            Essayer maintenant
          </button>
        </div>
      </div>
    ...
    <section className="py-20 bg-[var(--bg)]">
      <div className="container max-w-[1200px] mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h3 className="text-2xl font-bold text-[var(--ink)] mb-6">
              ...
              {features.map((feature, index) => (
                <div key={index} className="flex items-center">
                  <div className={`w-5 h-5 rounded-full flex items-center justify-center mr-3 ${
                    feature.included ? 'bg-[var(--brand)]' : 'bg-gray-300'
                  }`}>
                    {feature.included ? (
                  ...
                  <span className={feature.included ? 'text-[var(--ink)]' : 'text-[var(--muted)]'}>
                    {feature.name}
                  </span>
                </div>
              ))}
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm border">
            <div className="aspect-video bg-gradient-to-br from-[var(--brand)] to-[var(--accent)] rounded-xl mb-6 flex items-center justify-center">
            ...
            <h4 className="font-semibold text-[var(--ink)] mb-2">Interface intuitive</h4>
            <p className="text-[var(--muted)] text-sm mb-6">
              Créez vos vidéos en quelques clics grâce à notre interface pensée pour les professionnels de l'hôtellerie
            </p>
            <button className="w-full bg-[var(--brand)] text-white py-3 rounded-xl font-medium hover:scale-[1.01] transition-transform">
      ...
      <div className="container max-w-[1200px] mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          {personas.map((persona, index) => (
            <div key={index} className="bg-[var(--bg)] rounded-2xl p-8 text-center">
              <div className="text-4xl mb-4">{persona.icon}</div>
              <h3 className="text-xl font-bold text-[var(--ink)] mb-3">{persona.title}</h3>
              <p className="text-[var(--muted)] mb-6">{persona.description}</p>
              ...
              <button className="bg-[var(--brand)] text-white px-6 py-2 rounded-xl text-sm font-medium hover:scale-[1.01] transition-transform">
                En savoir plus
              </button>
            </div>
          ))}
        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="border-2 border-[var(--brand)] text-[var(--brand)] px-8 py-3 rounded-2xl font-medium hover:scale-[1.01] transition-transform">
              Programmer une démo
            </button>
          </div>
        </div>
      ...
      <div className="container max-w-[1200px] mx-auto px-4 md:px-6">
        <div className="text-center mb-16">
          ...
          <div className="flex items-center justify-center gap-4 mb-8">
            <span className={`text-sm ${!isAnnual ? 'text-[var(--ink)] font-medium' : 'text-[var(--muted)]'}`}>
              Mensuel
            </span>
            <button
              ...
              style={{
                backgroundColor: isAnnual ? 'var(--brand)' : '#e5e7eb'
              }}
            >
              <div
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {plans.map((plan, index) => (
            <div key={index} className={`bg-white rounded-2xl p-8 relative ${
              plan.popular ? 'border-2 border-[var(--accent)] shadow-lg' : 'border border-gray-200'
            }`}>
              {plan.popular && (
              ...
              <div className="text-center mb-8">
                <h3 className="text-2xl font-bold text-[var(--ink)] mb-2">{plan.name}</h3>
                <p className="text-[var(--muted)] mb-4">{plan.description}</p>
                
                {/* Custom counter for flexible plan */}
                {plan.customizable && (
                  <div className="mb-6 p-4 bg-gray-50 rounded-lg">
                    <label className="block text-sm font-medium text-[var(--ink)] mb-4">
                    ...
                    <div className="flex items-center justify-center gap-4 mb-4">
                      <button
                        ...
                        className="w-10 h-10 rounded-full border-2 border-[var(--brand)] text-[var(--brand)] font-bold text-xl flex items-center justify-center hover:bg-[var(--brand)] hover:text-white transition-colors disabled:opacity-30 disabled:cursor-not-allowed disabled:hover:bg-transparent disabled:hover:text-[var(--brand)]"
                      >
                        −
                      </button>
                ...
                <div className="mb-4">
                  {plan.customizable ? (
                    <div className="text-center">
                      <span className="text-4xl font-bold text-[var(--ink)]">€{selectedTier.price}</span>
                      <span className="text-[var(--muted)]">{isAnnual ? '/an' : '/mois'}</span>
                      {isAnnual && (
                    ...
                    <span className="text-4xl font-bold text-[var(--brand)]">Gratuit</span>
                  ) : (
                    <span className="text-2xl font-bold text-[var(--ink)]">{plan.price}</span>
                  )}
                  {plan.period && !plan.customizable && <span className="text-[var(--muted)]">{plan.period}</span>}
                </div>
              </div>

              <ul className="space-y-3 mb-8">
                {plan.features.map((feature, fIndex) => (
                  <li key={fIndex} className="flex items-center text-[var(--ink)]">
                    <svg className="w-5 h-5 text-[var(--brand)] mr-3" viewBox="0 0 20 20" fill="currentColor">
              ...
              <button className={`w-full py-3 px-6 rounded-2xl font-medium transition-all ${
                plan.popular 
                  ? 'bg-[var(--accent)] text-white hover:scale-[1.01]' 
                  : 'bg-[var(--brand)] text-white hover:scale-[1.01]'
              }`}>
                {plan.cta}
              </button>
            </div>
        ...
        <div className="text-center mt-12">
          ...
          <button className="bg-white text-[var(--brand)] px-8 py-3 rounded-2xl font-medium border-2 border-[var(--brand)] hover:scale-[1.01] transition-transform">
      ...
      <div className="container max-w-[1200px] mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center mb-4">
              <div className="w-8 h-8 bg-gradient-to-tl from-[#115446] to-[#138a73] rounded-lg flex items-center justify-center mr-3">
                <img 
                  src="/logo.png" 
                  alt="Hospup Logo" 
                  width={20} 
              ...
              <span className="text-2xl font-bold">{landingData.brand}</span>
            </div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-8 h-8 bg-gray-700 rounded-full flex items-center justify-center hover:bg-[var(--brand)] transition-colors">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
