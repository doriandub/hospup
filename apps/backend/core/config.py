...
class Settings(BaseSettings):
    ...
    # Security
    ALLOWED_HOSTS: str = "localhost,127.0.0.1,localhost:3000,localhost:3001,localhost:3002,localhost:3003,hospup-backend.onrender.com,*.onrender.com,hospup.vercel.app"
